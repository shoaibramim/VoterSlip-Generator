...
import { Sun, Moon, Upload, FileText, Download, Users, RefreshCw, MapPin, Building, Languages, Menu, X, Mail } from 'lucide-react';
...
function App() {
  ...
  const [currentPage, setCurrentPage] = useState<'main' | 'contact'>('main');
  ...
  // If on contact page, render contact component
          ...
          <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-2">
              <button 
                ...
                className="px-4 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors flex items-center gap-2"
              >
                <Mail size={16} />
                {language === 'en' ? 'Contact Developer' : 'যোগাযোগ করুন'}
              </button>
              <button 
          ...
          {showMobileMenu && (
            <div className="lg:hidden border-t border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-4 space-y-3">
              <button 
                ...
                className="w-full text-left px-4 py-3 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors flex items-center gap-2"
              >
                <Mail size={18} />
                {language === 'en' ? 'Contact Developer' : 'যোগাযোগ করুন'}
              </button>
          ...
          <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <a 
                  href="https://github.com/shoaibramim/VoterSlip-Generator" 
                  target="_blank" 
